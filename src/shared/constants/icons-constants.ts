...
export const APP_ICONS = {
    ...
    inventory2: 'fluent-mdl2:product-variant',
    orders:'material-symbols:orders-outline-rounded',
    billing: 'solar:bill-list-linear',
    order: 'material-symbols:order-approve-outline',
    notifications: 'tdesign:notification',
    pay_type: 'fluent:payment-24-regular',
    Product: 'icon-park-outline:ad-product',
    tProduct: 'fluent-mdl2:product-release',
    Size_categoty: 'fluent:resize-table-24-filled',
    color: 'ph:paint-brush',
    Sizes: 'fluent:resize-48-filled',
    bank: 'mingcute:bank-line',
    bankAccount: 'streamline:piggy-bank',
    bills: 'heroicons:banknotes',
    pay: 'ic:outline-payments',
    for_pay: 'mdi:payment',
    for_collect: 'fluent:money-hand-24-regular',
    settings: 'ep:setting',
    user: 'tdesign:user',
}
