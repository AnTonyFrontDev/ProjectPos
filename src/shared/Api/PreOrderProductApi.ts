...
import { IPreOrderProduct, IPreOrderProductSave} from "@/shared/interfaces/IPreOrderProduct";
...
export const UpdatePreOrderProduct = async (formData: IPreOrderProductSave) => {
    try {
