...
// import {expensesTable, PaymentExpensesTable} from "@/components/Generics/Tabla/tData";
// import {getExpenses, GetExpensesPaginated, GetPaymentExpenses, RemoveExpenses} from "@/shared/Api/Expenses/ExpensesApi";
...
//       GetPaymentExpenses(page,itemsPerPage)
//           .then((data)=>{
//             setApiData(()=>data);
...
//         />
//         <G_Options buttonText="Nuevo pago" usarForm="PaymentExpenses" />
//       </div>
//       <div className="mt-10">
//         <ApiTable
//           getApiData={async()=> apiData.data.data}
//           delApiData={RemoveExpenses}
//           //configurar para edicion
//           usarForm='PaymentExpenses'
//           columns={PaymentExpensesTable}
